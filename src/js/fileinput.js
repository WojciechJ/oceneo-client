...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeLabel: 'Usuń',
        removeTitle: 'Wyczyśc wybrane pliki',
        cancelLabel: 'Anuluj',
        cancelTitle: 'Anuluj wysyłanie',
        uploadLabel: 'Wyślij',
        uploadTitle: 'Wyślij wybrane pliki',
        msgNo: 'Nie',
        msgNoFilesSelected: 'Nie wybrano plików',
        msgCancelled: 'Anulowano',
        msgPlaceholder: 'Wybierz pliki...',
        msgZoomModalHeading: 'Szczegółowy podgląd',
        msgFileRequired: 'Musiz wybrać plik do wysłania.',
        ...
        msgUploadAborted: 'Wysyłanie pliku zostało zatrzymane',
        msgUploadThreshold: 'Przetwarzanie...',
        msgUploadBegin: 'Inicjowanie...',
        msgUploadEnd: 'Zakończono',
        msgUploadEmpty: 'Brak danych do wysłania.',
        msgUploadError: 'Błąd',
        msgValidationError: 'Błąd walidacji',
        msgLoading: 'Ładowanie pliku {index} z {files} &hellip;',
        msgProgress: 'Ładowanie pliku {index} z {files} - {name} - {percent}% zakończono.',
        msgSelected: '{n} {files} wybrane',
        msgFoldersNotAllowed: 'Przeciągnij & upuść tylko pliki ! Przeciągnięty folder został pominięty.',
        msgImageWidthSmall: 'Szerokość obrazu "{name}" musi być przynajmniej {size} px.',
        msgImageHeightSmall: 'wysokośc obrazu "{name}" musi być przynajmniej {size} px.',
        msgImageWidthLarge: 'Szerokośc obrazu "{name}" nie może przekraczać {size} px.',
        msgImageHeightLarge: 'Wysokośc obrazu "{name}" nie może przekraczać {size} px.',
        msgImageResizeError: 'Could not get the image dimensions to resize.',
        msgImageResizeException: 'Error while resizing the image.<pre>{errors}</pre>',
        msgAjaxError: 'Coś poszło nie tak z{operation}. Spróbuj ponownie później!',
        msgAjaxProgressError: '{operation} zawiodło',
        ajaxOperations: {
            deleteThumb: 'usuwanie pliku',
            uploadThumb: 'wysyłanie pliku',
            uploadBatch: 'wysyłanie wielu plików',
            uploadExtra: 'wysyłanie formularza'
        },
        dropZoneTitle: 'Przeciągnij & upuść pliki tutaj &hellip;',
        dropZoneClickTitle: '<br>(lub kliknij przeglądaj{)',
        previewZoomButtonTitles: {
            prev: 'Zobacz poprzedni plik',
            next: 'Zobacz następny plik',
            toggleheader: 'Włącz/Wyłącz nagłowek',
            fullscreen: 'Włącz/Wyłącz pełny ekran',
            borderless: 'Włącz/Wyłącz tryb bezramkowy',
